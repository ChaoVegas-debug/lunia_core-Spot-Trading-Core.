...
from app.compat.prom import (Counter, Gauge, Histogram, Summary,
...
funds_limits_changes_total = Counter(
    "lunia_funds_limits_changes_total",
    "Count of funds-in-work limit operations",
    labelnames=("action",),
)
...
strategy_applications_total = Counter(
    "lunia_strategy_applications_total",
    "Count of strategy configuration operations",
    labelnames=("action",),
)
...
explain_card_render_duration_seconds = Histogram(
    "lunia_explain_card_render_duration_seconds",
    "Time required to build explainable signal cards",
