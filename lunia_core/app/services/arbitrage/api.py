...
from .worker import (auto_tick, execute_by_id, get_execution, get_filters,
                     get_state, scan_now, toggle_auto_mode, update_filters)
...
def get_top() -> Any:
    ...
    return jsonify(
        {"opportunities": opportunities, "filters": _serialize_filters(get_filters())}
    )
